    ...
    case 3:      
      ...
      if (reply != null) {
         if (reply.getPerformative() == ACLMessage.INFORM) {
            //Send to field of the field buyer putput
            String myMsg = bookTitle+" successfully purchased from agent "+reply.getSender().getName() + " Price = "+bestPrice+"\n";
            System.out.println(myMsg);
            BookBuyerGui buyerGui = bbAgent.getBookBuyerGui(bbAgent);
            buyerGui.setTxtToJTxtArea(myMsg);
